...
router.post("/addUser", authMiddleware, restrictTo(Permissions.ADD_USER),(req, res) =>  userController.addUser(req as AuthenticatedRequest, res));
...
router.put("/editUserRole", authMiddleware, restrictTo(Permissions.EDIT_USER_ROLE), (req, res) => userController.editUserRole(req as AuthenticatedRequest, res));
