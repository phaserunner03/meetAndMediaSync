...
const CREDENTIALS_PATH = path.join(__dirname, '../config/googleCredentials.json');
...
/**
 * Handles Google OAuth2 authorization.
 */
...
async function createEvent(eventData) {
    try {
        ...
        const response = await calendar.events.insert({
            calendarId: 'primary',
            resource: event,
            conferenceDataVersion: 1, // Needed for Google Meet links
        });
